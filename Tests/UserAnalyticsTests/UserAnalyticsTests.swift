...
class UserAnalyticsTests: XCTestCase {
    // This test actually makes a network request.
    //
    // TODO: Stub out network requests.
    //
    // You'll need to pass the following environment variables in:
    //
    //   * USER_ANALYTICS_TOKEN
